...
import { Conteudo, ConteudoJSON } from '../filmes-entities.js';
...
describe('Conteudo - construtor', () => {
  ...
  it('deve lançar erro se o título for vazio', () => {
    ...
    expect(() => new Conteudo(paramsValidos({ titulo: '' }))).toThrow(
      'O titulo do filme é obrigatório.',
    );
  });
  ...
  it('deve lançar erro se o ano de lançamento for menor que 1888', () => {
    ...
    expect(() => new Conteudo(paramsValidos({ anoLancamento: 1887 }))).toThrow(
  ...
  it('deve lançar erro se o ano de lançamento for maior que anoAtual + 5', () => {
    ...
    expect(() => new Conteudo(paramsValidos({ anoLancamento: anoAtual + 6 }))).toThrow(
      'Ano de lançamento inválido.',
    );
  });
  ...
  it('deve lançar erro se o ano de lançamento for 0', () => {
    ...
    expect(() => new Conteudo(paramsValidos({ anoLancamento: 0 }))).toThrow(
      'Ano de lançamento inválido.',
    );
  });
...
describe('Conteudo.fromJSON', () => {
  ...
  it.each([
    ...
    expect(() => Conteudo.fromJSON(invalido)).toThrow(
      `Campo "${String(campo)}" é obrigatório e deve ser uma string.`,
    );
  });
  ...
  it('deve lançar erro se "genero" não for string nem número', () => {
    ...
    expect(() => Conteudo.fromJSON(invalido)).toThrow(
      'Campo "genero" é obrigatório e deve ser string ou número.',
    );
  });
  ...
  it('deve lançar erro se "anoLancamento" não for número', () => {
    ...
    expect(() => Conteudo.fromJSON(invalido)).toThrow(
      'Campo "anoLancamento" é obrigatório e deve ser numérico.',
    );
  });
  ...
  it('deve lançar erro se "duracao" não for número', () => {
    ...
    expect(() => Conteudo.fromJSON(invalido)).toThrow(
      'Campo "duracao" é obrigatório e deve ser numérico.',
    );
  });
  ...
  it('deve lançar erro se "avaliacao" for informado mas não for número', () => {
    ...
    expect(() => Conteudo.fromJSON(invalido)).toThrow(
      'Campo "avaliacao", quando informado, deve ser numérico.',
    );
  });
  ...
  it('deve reaproveitar a validação de título do construtor', () => {
    ...
    expect(() => Conteudo.fromJSON(invalido)).toThrow('O titulo do filme é obrigatório.');
  });

  it('deve reaproveitar a validação de ano de lançamento do construtor', () => {
    // Confirma que fromJSON chama a mesma validarAnoLancamento usada no construtor
    const invalido = { ...jsonValido, anoLancamento: 1800 };
    expect(() => Conteudo.fromJSON(invalido)).toThrow('Ano de lançamento inválido.');
  });
});
